...
function typeOfEmail(userEmailAdress) {
    if (userEmailAdress.includes("@novi-education.nl")) {
        return console.log("Student")
    }
    if (userEmailAdress.includes("@novi.nl")) {
...
typeOfEmail("nova.eeken@novi-education.nl")
